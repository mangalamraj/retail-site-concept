  ...
  return (
    <div className="max-w-380   m-auto md:text-center z-10">
      ...
      <div className="flex gap-4 flex-col xl:flex-row w-[90%] md:w-[80%] justify-center m-auto">
        <div
          className={` bg-gray-300/20 dark:bg-zinc-950  border-zinc-800 dark:border xl:w-1/4   rounded-xl flex bg-[url(/cardeffect.svg)] bg-cover bg-center`}
        >
          <div className="flex flex-col md:gap-12 m-4  text-left">
            ...
            <div className="py-4 px-2">
              <div className="text-lg   pb-2">Lightning Fast Setup</div>
        ...
        <div
          className={` bg-gray-300/20 dark:bg-zinc-950  border-zinc-800 dark:border xl:w-1/4   border-zinc-800 dark:border-2    rounded-xl flex bg-[url(/cardeffect.svg)] bg-cover bg-center`}
        >
          <div className="flex flex-col md:gap-12 m-4  text-left">
            <div className="group flex m-2 gap-2  text-white p-1 rounded-full items-center duration-300 group-hover:px-4 font-semibold cursor-pointer">
            ...
            <div className="py-4 px-2 ">
              <div className="text-lg  pb-2">Real-time Updates</div>
        ...
        <div
          className={` bg-gray-300/20 100 dark:bg-zinc-950  border-zinc-800 dark:border  xl:w-1/4   border-zinc-800 dark:border-2    rounded-xl flex bg-[url(/cardeffect.svg)] bg-cover bg-center`}
        >
          <div className="flex flex-col md:gap-12 m-4  text-left">
            <div className="group flex m-2 gap-2  text-white p-1 rounded-full items-center duration-300 group-hover:px-4 font-semibold cursor-pointer">
              <div className=" rounded-full  bg-black hover:rotate-180 duration-300">
            ...
            <div className="py-4 px-2">
              <div className="text-lg   pb-2">Mobile First</div>
        ...
        <div
          className={` bg-gray-300/20 100 dark:bg-zinc-950  border-zinc-800  dark:border-2  xl:w-1/4   border-zinc-800   rounded-xl flex bg-[url(/cardeffect.svg)] bg-cover bg-center`}
        >
          <div className="flex flex-col md:gap-12 m-4  text-left">
            <div className="group flex m-2 gap-2  text-white  p-1 rounded-full items-center duration-300 group-hover:px-4 font-semibold cursor-pointer">
              <div className=" rounded-full  bg-black hover:rotate-180 duration-300">
            ...
            <div className="py-4 px-2">
              <div className="text-lg  pb-2">Automated Workflows</div>
              <div className="text-sm font-medium text-gray-600 dark:text-gray-400">
